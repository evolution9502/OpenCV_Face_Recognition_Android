		  ...
		  switch (event.getAction()) {
		    case MotionEvent.ACTION_DOWN:
		    	...
		    	if(MatFace != null)
		    	{
		    		...
		    		System.out.println("yunk new image name is " + testImageName);
		    		...
		    		if (bool == true){
		    		    System.out.println("yunk SUCCESS writing image to external storage");
		    		}
		    		  else{
		    		    System.out.println( "yunk Fail writing image to external storage");
		    		  }
