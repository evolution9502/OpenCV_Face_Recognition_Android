...
public class Database extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        gridView.setOnItemClickListener(new OnItemClickListener() {
			...
			/*	ImageItem item = (ImageItem) parent.getItemAtPosition(position);
				System.out.println("yunk imageitem retrieved");
				//Create intent
				Intent intent = new Intent(Database.this, DetailsActivity.class);
				System.out.println("yunk details acitvity intent declared");
				intent.putExtra("title", item.getTitle());
				System.out.println("yunk title put into intent");
				intent.putExtra("image", item.getImage());
				System.out.println("yunk image put into intent");

				//Start details activity
				startActivity(intent);
				System.out.println("yunk actual acitivty started");
				*/
				ImageItem item = (ImageItem) parent.getItemAtPosition(position);
				//Create intent
	...
	private ArrayList<ImageItem> getData() {
        ...
        {
        	System.out.println("yunk " + " couldnt do it boss " + e.getMessage() );
        }
